...
public class Arrays_Introduction {
	...
	//2. Faster compared to primitive data types because primitive data types use internal conversion of Wrapper Classes
	...
	public static void main(String[] args) {
		...
		//There are 1000 students or employees in a company and want to store their stu_id, emp_id, student_name, emp_name
